        ...
        {open && (
          <Modal>
            <div>
              ...
              <Topsvg
                className=" absolute  topSvg -top-12 -left-11 scale-75"
                style={{ borderRadius: "24px 0px 0px 0px" }}
              />
              <Bottomsvg
                className=" absolute bottomSvg -bottom-12 -right-11 scale-75"
                style={{ borderRadius: "0px 0px 24px 0px" }}
              />
            </div>
          </Modal>
        )}
