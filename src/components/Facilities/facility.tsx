    ...
    <div className="h-screen overflow-y-auto max-h-screen p-5 md:p-6 md:pr-9 bg-background w-full max-w-full md:w-4/5 lg:w-5/6 box-border">
      ...
      {hasData ? (
        <>
          ...
          <div className="flex justify-between items-center px-6 py-4 mb-4 bg-white shadow-[4px_4px_3.2px_0px_rgba(100,132,230,0.20)] rounded-2xl">
            <button className="flex justify-center gap-x-2 items-center rounded-xl  h-7 md:h-10 w-24 md:w-44">
              <p className="text-sm md:text-base font-bold">Booked Facilities</p>
              <div className=" w-5 h-5  p-0.5 2xl:w-6 2xl:h-6 flex justify-center items-center">
                <KeyboardArrowDownIcon className="scale-[0.7] lg:scale-75" />
              </div>
            </button>
          ...
          <div className="grid gap-3 2xl:gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white rounded-2xl p-3 2xl:p-5 h-56 md:h-[25vh] 2xl:h-[27vh] shadow-[4px_4px_3.2px_0px_rgba(100,132,230,0.20)]">
              <div className="flex justify-between items-center h-[10%] ">
                <h6 className="text-sm md:text-md xl:text-base  font-bold">
              ...
              <div className="h-[45%] md:h-[50%] lg:h-[45%] flex flex-col justify-evenly">
                ...
                <p className="text-sm flex">
                  <span className="flex justify-center items-center mr-2 bg-[#00FF00] h-5 w-5 rounded-full"><Approved /></span>
                  <span>Bookings 30</span>
                </p>
              </div>
              <div className="h-[45%] bg-primary p-3  rounded-2xl md:h-[40%] lg:h-[45%]">
                <p className="font-bold text-sm mb-1 md:mb-2">Swimming Pool</p>
                <div className="flex justify-between items-center">
                  <div className="flex-1">
                    <p className="text-ellipsis overflow-hidden whitespace-nowrap">24 jasmine road</p>
                    <p className="text-sm">07066993080</p>
                  </div>
                  <button className="flex justify-center gap-x-2 items-center rounded-full text-xs md:text-sm bg-accenture  h-9 md:h-10 w-24 md:w-28">
                    Block now
                  </button>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-2xl p-3 2xl:p-5 h-60 md:h-[25vh] lg:h-[36vh] 2xl:h-[27vh] shadow-[4px_4px_3.2px_0px_rgba(100,132,230,0.20)] relative">
              <div className="flex justify-between items-center h-[10%] ">
                <h6 className="text-sm md:text-md xl:text-base  font-bold">
                  {new Date().toDateString()}
                </h6>
              ...
              <div className="bg-primary p-3  rounded-2xl md:h-[40%] lg:h-[45%]">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm">24 jasmine road</p>
                    <p className="text-sm">07066993080</p>
                  </div>
                  <button className="flex justify-center gap-x-2 items-center rounded-full text-xs md:text-sm bg-accenture  h-9 md:h-10 w-24 md:w-28 lg:w-24 lg:h-9 xl:w-28">
                    Block now
                  </button>
                </div>
              </div>
              <TopRight className='absolute'/>
            </div>
            <div className="bg-white rounded-2xl p-3 2xl:p-5 h-60 md:h-[25vh] 2xl:h-[27vh] shadow-[4px_4px_3.2px_0px_rgba(100,132,230,0.20)]">
              <div className="flex justify-between items-center h-[10%] ">
                <h6 className="text-sm md:text-md xl:text-base  font-bold">
                  {new Date().toDateString()}
                </h6>
