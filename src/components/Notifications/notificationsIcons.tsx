...
const NotificationIcons: React.FC = () => {
  return (
    <div className="flex">
      <Link to='/alarms'>
        <div className="bg-background md:bg-white relative shadow-none md:shadow-[0px_3px_5px_rgba(100,132,230,0.20)] rounded-full w-8 h-8 xl:w-10 xl:h-10 mr-2 flex items-center justify-center">
